...
export default function WhatsAppButton({ property, className = '', label = 'Contactar por WhatsApp' }) {
  const message = property
    ? `Hola, me interesa la propiedad: ${property.title} en ${property.location}. Precio: ${property.priceFormatted}. ¿Podrían darme más información?`
    : 'Hola, me interesa una propiedad de LGAI Realty Inmuebles. ¿Podrían darme más información?';
